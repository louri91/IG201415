...
int dibujar2 = 4;
char *fichero = "/Users/Louri/Desktop/PRACTICASUGR/IG/P2IG/P2IG/ant.ply";
char *perfilPeon = "/Users/Louri/Desktop/PRACTICASUGR/IG/P2IG/P2IG/perfil.ply";
int modo = 3;
MallaTVT malla1;
MallaTVT malla2;
int numero;
...
void draw_objects()
{
    ...
    switch (dibujar2)
    {
        case 1:
            if(malla1.num_ver == 0)
                generar_malla(&malla1, fichero, false, 20);
            MTVT_Visualizar_VBOs_AV(&malla1);
            break;
        case 2:
            if(malla2.num_ver == 0)
                generar_malla(&malla2,perfilPeon,true,5);
